    ...
    fetch('https://raw.githubusercontent.com/davidgrhub/JsonRepositoryNexus/refs/heads/main/productos.json')
        ...
        .then(productos => {
            ...
            $(`#${idSlider}`).slick({
                ...
                prevArrow: '<button class="slick-prev" onclick="event.preventDefault();><svg class="slick-prevSVG" width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="39.5" y="39.5" width="39" height="39" rx="19.5" transform="rotate(-180 39.5 39.5)" stroke="black"/><path d="M14.0001 20.3043C14.0001 20.0067 14.1229 19.709 14.3682 19.4821L22.0896 12.3407C22.5808 11.8864 23.3771 11.8864 23.8681 12.3407C24.3591 12.7948 24.3591 13.5312 23.8681 13.9855L17.0358 20.3043L23.8679 26.6231C24.3588 27.0774 24.3588 27.8138 23.8679 28.2678C23.3769 28.7223 22.5805 28.7223 22.0893 28.2678L14.3679 21.1265C14.1227 20.8995 14.0001 20.6019 14.0001 20.3043Z" fill="#494949"/></svg></button>',
                nextArrow: '<button class="slick-next" onclick="event.preventDefault();><svg class="slick-nextSVG" width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="0.5" y="0.5" width="39" height="39" rx="19.5" stroke="#494949"/><path d="M27.2363 20.3043C27.2363 20.602 27.1134 20.8996 26.8681 21.1265L19.1467 28.2679C18.6556 28.7222 17.8592 28.7222 17.3682 28.2679C16.8773 27.8138 16.8773 27.0774 17.3682 26.6231L24.2006 20.3043L17.3685 13.9855C16.8775 13.5312 16.8775 12.7949 17.3685 12.3408C17.8594 11.8863 18.6558 11.8863 19.147 12.3408L26.8684 19.4821C27.1137 19.7091 27.2363 20.0068 27.2363 20.3043Z" fill="#494949"/></svg></button>',
                responsive: [
...
export function ajusteContenidoCard(colorSVG) {
    ...
    const text = {es:"Regístrate y obtén un 5% de descuento adicional",
                    ...
                    fr:"Inscrivez-vous et obtenez 5 % de réduction en plus"}[obtenerIdioma()];
